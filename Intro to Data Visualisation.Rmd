...
When I forked the repository, it asked if I wanted to create a copy in my own GitHub. It looks as if forking is a way to create an identical copy so more than one person can work on a project?!
